 ...
 *
 * This file is the Search Page template file, which is output whenever
...
<?php
	...
	$search_sidebar_loc = $kaex_options['kaex_search_sidebar_loc'];  
?>
<?php get_header(); ?>
<div id="main-section">
	<div id="content-wrap">
		<?php if ( $search_sidebar_loc == 'left') { ?>
			<div id="widecolumn-right">
		<?php } else { ?>
			<div id="widecolumn-left">
		<?php } ?>
			<div class="search-page">
				<h2><?php _e('Search Results : ','ka_express'); echo the_search_query(); ?></h2>
			</div>
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<div class="nosearch">
					...
					<p><?php _e('You may want to try another search.','ka_express'); ?></p>
