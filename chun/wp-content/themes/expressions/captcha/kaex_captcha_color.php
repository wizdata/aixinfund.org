...
<?php
	...
	// Create the image  
	$kaex_img = imagecreatetruecolor($captcha_width, $captcha_height);  
	...
	for ($i = 0; $i < $number_characters; $i++) {
		...
		imagecopy($kaex_img,$letter_img,$xpos,$ypos,0,0,24,24);
		$xpos = $xpos + 24;
	}
  
	// Store the encrypted pass-phrase in a session variable
	$_SESSION['kaex_pass_phrase'] = SHA1($pass_phrase);
